...
goog.require 'lempera.trafficCounter.viewer.users.list.Presenter'
goog.require 'lempera.trafficCounter.viewer.users.detail.Presenter'
...
lempera.trafficCounter.viewer.start = (data) ->
  ...
  viewer.storage = new este.storage.Rest(data['baseUrl']+'/api/v2/')
  viewer.addRoutes
    '/traffic/:interval': new lempera.trafficCounter.viewer.traffic.Presenter
    '/users/:interval': new lempera.trafficCounter.viewer.users.list.Presenter
    '/user/:ip/:interval': new lempera.trafficCounter.viewer.users.detail.Presenter
